...
UPSTREAM_REPO = getenv(
    "UPSTREAM_REPO",
    "https://github.com/Nikchil/LykaRobot",
)
...
SUPPORT_CHANNEL = getenv("SUPPORT_CHANNEL", "https://t.me/GrayBotSupport")
SUPPORT_CHAT = getenv("SUPPORT_CHAT", "https://t.me/GrayBots")
